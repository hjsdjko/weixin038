...
public class YonghuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YonghuEntity u = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("shouji", username));
    ...
    public R wxLogin(@RequestBody WxLoginParam param) {
        ...
        if (user == null) {
            ...
            //已绑定，登录成功
            token = tokenService.generateToken(user.getId(), user.getShouji(),"yonghu", "用户");
        }
    ...
    public R register(@RequestBody YonghuEntity yonghu){
    	...
    	YonghuEntity u = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("shouji", yonghu.getShouji()));
		if(u!=null) {
